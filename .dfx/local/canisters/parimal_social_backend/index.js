...
import { idlFactory } from './parimal_social_backend.did.js';
export { idlFactory } from './parimal_social_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PARIMAL_SOCIAL_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./parimal_social_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the parimal_social_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./parimal_social_backend.did.js")._SERVICE>}
 */
export const parimal_social_backend = createActor(canisterId);

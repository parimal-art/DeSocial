...
import { idlFactory } from './social_T7_backend.did.js';
export { idlFactory } from './social_T7_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SOCIAL_T7_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./social_T7_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the social_T7_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./social_T7_backend.did.js")._SERVICE>}
 */
export const social_T7_backend = createActor(canisterId);

...
import { idlFactory } from './social_T7_frontend.did.js';
export { idlFactory } from './social_T7_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SOCIAL_T7_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./social_T7_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the social_T7_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./social_T7_frontend.did.js")._SERVICE>}
 */
export const social_T7_frontend = createActor(canisterId);
